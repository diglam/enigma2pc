...
class PictureInPicture(Screen):
	...
	def setSizePosMainWindow(self, x = 0, y = 0, w = MAX_X, h = MAX_Y):
		open("/usr/local/e2/etc/stb/vmpeg/0/dst_left", "w").write("%x" % x)
		open("/usr/local/e2/etc/stb/vmpeg/0/dst_top", "w").write("%x" % y)
		open("/usr/local/e2/etc/stb/vmpeg/0/dst_width", "w").write("%x" % w)
		open("/usr/local/e2/etc/stb/vmpeg/0/dst_height", "w").write("%x" % h)
		open("/usr/local/e2/etc/stb/vmpeg/0/dst_apply", "w").write("%x" % 1)
